...
# Resolve imports and paths relative to this file
...
# Absolute paths anchored to this script directory
...
def main():
    try:
        ...
        # Let Node know the file path we wrote
